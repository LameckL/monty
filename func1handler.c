...
/**
 * pint_handler - func handling pint instructions
 * @stack: stack double pointer pushed to
...
/**
 * nop_handler - thif func handles the nop instructions
 * @stack: stack double ptr to push to
 * @line_number: line no. on the file
 */
