...
/**
 * get_func - func for choosing the correct function
 * @parsed: bytecode file passed to the main
 * Return: chosen function pointer - success, NULL - failure
 */
...
/**
 * push_handler - this func handle push instructions
